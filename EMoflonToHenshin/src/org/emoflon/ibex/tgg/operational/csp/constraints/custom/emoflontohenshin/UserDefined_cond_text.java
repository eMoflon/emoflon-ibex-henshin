...
public class UserDefined_cond_text extends RuntimeTGGAttributeConstraint {

	/**
	 * Constraint cond_text(param, op, val, condText)
	 * 
	...
	public void solve() {
		if (variables.size() != 4)
			throw new RuntimeException("The CSP -COND_TEXT_CONSTR- needs exactly 4 variables");
		...
		if (bindingStates.equals("BBBB")) {
			...
			ResolvedCondText resCondText = UserDefConstrUtil.resolveCondText((String) condText.getValue(), false);
