...
public class _SchemaBasedAutoRegistration {
	...
	public static void register(OperationalStrategy strategy) throws IOException {
		strategy.loadAndRegisterMetamodel("platform:/resource/TrainLanguage/model/TrainLanguage.ecore");
		strategy.loadAndRegisterMetamodel("platform:/resource/VehicleLanguage/model/VehicleLanguage.ecore");
	}
